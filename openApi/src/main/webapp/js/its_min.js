...
function AreaCode() {
	...
	this.getMapAreaCode = function(map, Mando, AreaChanged) {
		...
		var url = './../map/getproxy.do?url=http://192.168.11.20/getAreaCode?lonlat=' + lonlat.lon + ',' + lonlat.lat;
		var areaCode = this;
...
function Traffic() {
	...
	this.getLinkVertex = function(id, level) {
		...
		$.post(url, {
			url : "http://192.168.11.20:8900/rota",
	...
	this.getLinkInfo = function(evt) {
		...
		var url = "./../map/getproxy.do?url=http://192.168.11.20:8900/rota&operation=GetTrafficInfo&level="
		...
		if (level > 9) {
			...
			url = "./../map/getproxy.do?url=http://192.168.11.20:8900/rota&operation=GetTrafficInfo&level="
					+ level
					+ "&lonlat="
					+ lonlat.lon
					+ ","
