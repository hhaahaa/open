...
function StreamCctv(cctvid, mapType){
	...
	this.cctvHTML_Seoul = function(){
		...
		return "<object id='mov' classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0' width='320' height='240'>"
		  ...
		  //+ "<param name='flashvars' value='file="+ this.gId +".stream&streamer=rtmp://61.108.209."+ this.gCh +":1935/live&bufferlength=3&autostart=true&stretching=exactfit&fullscreen=true&image=http://www.utic.go.kr/contents/js/img/320240-5.gif&skin=http://www.utic.go.kr/contents/js/img/skin_black30live.swf&frontcolor=FFFFFF&lightcolor=00AEEF&backcolor=111111' />"
