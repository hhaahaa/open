...
<script type="text/javascript" src="http://openapi.its.go.kr/javascript/openapi.weather.js"></script>
<script type="text/javascript">
	window.onload = init;
	var map;
	function init() {
		...
		// CCTV 종료
		// 날씨정보 시작
		var weather = new Weather('weatherLayer');
		POPUP_LAYERS.push(weather.getLayer());
		weather.getList();
		// 날씨정보 종료
