...
<html>
    ...
    <body>
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?libraries=drawing,geometrykey=AIzaSyBPA_xStX4VRi97SvEHjPOjZjlIC6aRWcs&v=3&callback=initMap">
        </script>
